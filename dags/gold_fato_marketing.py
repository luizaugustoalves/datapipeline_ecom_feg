"""
DAG: Gold - Fato Marketing Performance
Performance de campanhas com receita atribuída e ROAS por campanha.
...
with DAG(
    dag_id='gold_fato_marketing_performance',
    default_args=get_default_args(),
    description='Gold: Performance de campanha com ROAS',
    schedule_interval=None,
    start_date=datetime(2026, 2, 17),
    catchup=False,
    max_active_runs=1,
    tags=['ecommerce', 'gold', 'fato', 'marketing'],
